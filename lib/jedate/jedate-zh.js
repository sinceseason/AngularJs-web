	...
	*/
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            if(opts.isBegin){
                arrTime[3] = arrTime[4] = arrTime[5] = 0;
                date.setHours(arrTime[3]);
                date.setMinutes(arrTime[4]);
                date.setSeconds(arrTime[5]);
            }else{
                arrTime[3] = 23;
                arrTime[4] = 59;
                arrTime[5] = 59;
        ...
        events:function(that, opts, self, arrTime) {
            ...
            if (!isformat) {
                ...
                jeDt.on(QD(Cell + " .jedatebot .jedatetodaymonth")[0], "click", function() {
                    ...
                    jeDt.html(QD(Cell)[0], "");
                    jeDt.shdeCell(true);
                    if (opts.choosefun === "function" || opts.choosefun != null) opts.choosefun(gettoDate,opts.isBegin);
                });
            } else {
            ...
            jeDt.on(QD(Cell + " .jedatebot .jedateclear")[0], "click", function() {
                ...
                jeDt.shdeCell(true);
				if(clearVal != ""){
				    if (opts.clearfun === "function" || opts.clearfun != null) opts.clearfun(clearVal,opts.isBegin);
				}
            });
            //确认
            jeDt.on(QD(Cell + " .jedatebot .jedateok")[0], "click", function(ev) {
                ...
                jeDt.shdeCell(true);
				if(okVal != ""){
				    if (opts.okfun === "function" || opts.okfun != null)opts.okfun(okVal,opts.isBegin);

				}else if (opts.okfun === "function" || opts.okfun != null)opts.okfun(okVal,opts.isBegin);
            });
            //点击空白处隐藏
            ...
            jeDt.each(QD(Cell + " .jedaul li"), function(i, cls) {
                jeDt.on(cls, "click", function(ev) {
                    ...
                    if (opts.choosefun === "function" || opts.choosefun != null) {
                        opts.choosefun(getParDate,opts.isBegin);
                    }
                });
            });
        }
